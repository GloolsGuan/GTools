 ...
 * */
function blocker_block_lpw_info(){
	return array(
        'info'  => t('Lasooo Copy Right'),
        /*
...
function blocker_block_lpw_view($delta){
	return array(
        'subject' => '',
        'content' => '南京独立先锋书店，&nbsp;&nbsp;-&nbsp;&nbsp;阅读，启迪智慧，丰富人生! &nbsp;&nbsp;&nbsp; Powered by <a href="http://glools.com">GLOOLS Team</a>.&nbsp;GloolsGuan@glools.com&nbsp;&nbsp;&nbsp;沪ICP备09092923号-1'
    );
}